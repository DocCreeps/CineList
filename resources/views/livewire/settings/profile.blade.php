    ...
    <div class="mx-auto max-w-2xl px-4 pb-14 sm:px-8 lg:px-12">
        ...
        <div class="mt-6 rounded-2xl border border-red-900/50 bg-red-950/10 p-6 shadow-2xl sm:p-8">
            ...
            <div class="mt-5">
                ...
                @else
                    <form wire:submit="deleteAccount" x-data="throttleCountdown" class="max-w-sm space-y-3">
                        <div>
                            ...
                            <x-password-input wire:model="password" id="delete-password" tone="red" autocomplete="current-password" required autofocus />
